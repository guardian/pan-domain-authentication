...
import com.gu.pandomainauth.PageRequestHandlingStrategy.ANTI_FORGERY_KEY
import com.gu.pandomainauth.internal.*
import com.gu.pandomainauth.model.{AuthenticatedUser, CookieSettings, User}
...
sealed trait EndpointType {
  ...
  type RM
  type RespModReifier = RM => ResponseModification
}
